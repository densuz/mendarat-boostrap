...
<body>
  ...
  <header id="header" class="fixed-top d-flex align-items-center header-transparent">
    <div class="container d-flex align-items-center">
      ...
      <div class="logo mr-auto">
        <h1 class="text-light"><a href="/index.php"><span>e-APBDes</span></a></h1>
      ...
      <div class="row">
        <div class="col-lg-7 pt-5 pt-lg-0 order-2 order-lg-1 d-flex align-items-center">
          <div data-aos="zoom-out">
            <h1>Aplikasi Sistem Anggaran Keuangan <span> Desa</span></h1>
            <h2>Awasi Penggunaan Anggaran Dana Desa Melalui Aplikasi e-APBDes</h2>
            <div class="text-center text-lg-left">
              <a href="./pages/login.php" class="btn-get-started scrollto">Login</a>
            </div>
          </div>
        </div>
  ...
  <footer id="footer">
    ...
    <div class="container">
      <div class="copyright">
        &copy; Copyright <strong><span>Densuz</span></strong>. All Rights Reserved
      </div>
      <div class="credits">
